...
public class IRRenderer extends EffectRenderer implements Renderer,
    ...
    private void makeTransBuffer() {
        for (int i = 0; i < NUM_OF_INSTANCE; i++) {
            mTrans[i * NUM_OF_ELEMENT + 0] = (mRandom.nextFloat() - 0.5f) * mScreenRatio * 2f;
    ...
    public void setupVAO(GLESObject object) {
        ...
        GLES30.glEnableVertexAttribArray(GLESConfig.USER_LOCAITON_OFFSET);

        boolean useVBO = object.useVBO();
        if (useVBO == true) {
            GLES30.glBindBuffer(GLES30.GL_ARRAY_BUFFER,
                    mVBOID);
            GLES30.glVertexAttribPointer(GLESConfig.USER_LOCAITON_OFFSET,
        ...
        GLES30.glVertexAttribDivisor(GLESConfig.USER_LOCAITON_OFFSET, 1);
    }
    ...
    public void disableVertexAttribute(GLESObject object) {
        ...
        GLES30.glDisableVertexAttribArray(GLESConfig.USER_LOCAITON_OFFSET);
    }
}
